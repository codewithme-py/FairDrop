...
class PreSignedUrlForS3User(BaseUser):
    """
    Load user for testing presigned URL generation for S3 uploads.

    Focuses on the media upload presigned URL endpoint to measure
    ...
    def get_presigned_url(self) -> None:
        """Request a presigned upload URL for a test JPEG image."""
